...
/**
 * The `Angle` tag is used to add a rectangle (Bounding Box) to an image without selecting a label. This can be useful when you have only one label to assign to a rectangle.
 *
 ...
 * </View>
 * @name Angle
 * @meta_title Angle Tag for Adding Angle Bounding Box to Images
 * @meta_description Customize Label Studio with the Angle tag to add rectangle bounding boxes to images for machine learning and data science projects.
